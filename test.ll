...
@tmp.2 = private unnamed_addr constant [3 x i8] c"\0A\0A\00"
@tmp.3 = private unnamed_addr constant [18 x i8] c" constructor ok!\0A\00"
@tmp.4 = private unnamed_addr constant [7 x i8] c"%s%d%s\00"
...
then:                                             ; preds = %entry
  ...
  %tmp1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @tmp.1, i32 0, i32 0), i32 2)
  br label %ifcont
...
ifcont:                                           ; preds = %else, %then
  ...
  %c6 = load i32, i32* %c
  %tmp7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @tmp.4, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @tmp.2, i32 0, i32 0), i32 %c6, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @tmp.3, i32 0, i32 0))
  ret i32 0
}
