...
loop:                                             ; preds = %cond
  %j1 = load i32, i32* %j
  %tmp = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @tmp, i32 0, i32 0), i32 %j1)
  %j2 = load i32, i32* %j
  %subtmp = sub i32 %j2, 1
...
loop:                                             ; preds = %cond
  %i1 = load i32, i32* %i
  %tmp = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @tmp.1, i32 0, i32 0), i32 %i1)
  br label %step
